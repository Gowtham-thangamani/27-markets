...
export function FeatureCard({ icon: Icon, title, description }: FeatureCardProps) {
  ...
  return (
    ...
    >
      {onLight ? (
        <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500 ring-1 ring-brand-500/15 transition-all duration-300 group-hover:scale-110 group-hover:bg-brand-500/15">
