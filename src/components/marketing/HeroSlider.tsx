...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    lineKeys: ['hero2.line1', 'hero2.line2', 'hero2.line3'],
    tagline: 'Rebates · Tools · Dedicated Support',
    taglineKey: 'hero2.tagline',
    description:
      'Earn competitive rebates with powerful partner tools and dedicated support to grow your business across global markets.',
    descKey: 'hero2.desc',
    primary: { label: 'Become a Partner', to: '/partnership', labelKey: 'hero2.ctaPrimary' },
    secondary: { label: 'Learn More', to: '/partnership', labelKey: 'hero2.ctaSecondary' },
    visual: 'analytics',
  },
  {
    id: 'growth',
    ...
    lineKeys: ['hero3.line1', 'hero3.line2', 'hero3.line3'],
    tagline: 'Tight Spreads · Fast Execution',
    taglineKey: 'hero3.tagline',
    description:
      'Spreads from 0.0 pips and sub-30ms execution mean more of every winning trade stays in your account.',
    descKey: 'hero3.desc',
    primary: { label: 'Explore Accounts', to: '/accounts', labelKey: 'hero3.ctaPrimary' },
    secondary: { label: 'Open Account', to: '/register', labelKey: 'hero3.ctaSecondary' },
    visual: 'coins',
  },
]
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {slide.visual === 'analytics' && (
                <div className="relative">
                  {/* Ambient glow so the transparent graphic sits in the scene. */}
                  <div
                    aria-hidden
                    className="pointer-events-none absolute left-1/2 top-1/2 h-[70%] w-[80%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-500/20 blur-3xl"
                  />
                  <img
